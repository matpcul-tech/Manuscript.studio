        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { n: '04', title: 'Edit', body: 'AI Detection Score plus Somatic Interiority Score, the deepest test of whether prose feels human. Voice, pacing, and structure checks find specific issues and apply rewrites with one click. Nobody else does this.' },
